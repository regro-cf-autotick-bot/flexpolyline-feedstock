...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flexpolyline-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12499&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flexpolyline-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flexpolyline` can be installed with:

```
conda install flexpolyline
```

It is possible to list all of the versions of `flexpolyline` available on your platform with:
